...
const About = () => {
    ...
    return (
        <div className="container">
            <img src={Me} alt="Image of Me" className="me-img"></img>
        <div className="about-container">
            ...
            However, I always had a passion for technology and and in the last year I started to expand my acknowledge in programming. </p>
            So now, I want to expand my skills and acknowledge and start to put them in action!<br></br>
